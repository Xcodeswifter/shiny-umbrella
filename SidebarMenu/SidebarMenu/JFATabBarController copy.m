...
- (void)setSelectedIndex:(NSUInteger)selectedIndex
{
    ...
    [self setButtonImageAndColor:oldButton image:oldButton.imageView.image color:[UIColor whiteColor]];
    UIButton *newButton = self.tabButtons[selectedIndex];
    [self setButtonImageAndColor:newButton image:newButton.imageView.image color:[UIColor redColor]];
    CGFloat tabWidth = self.view.bounds.size.width / MAX_TAB_COUNT;
