...
//  GCTRACKV2BETA
//  Custom view controller for showing loading screen dialogs on top of another view controller
...
private class ActivityView: UIView {
    ...
    override func layoutSubviews() {
        ...
        boundingBoxView.frame.size.width = 620.0
        boundingBoxView.frame.size.height = 620.0
